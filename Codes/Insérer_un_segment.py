...
segment_a_insere = 6851

# Entre quels segments insérer ?

segment_de_gauche = 2590        # S'il s'agit du dernier segment, n'entrez que celui-ci
segment_de_droite = 2591        # S'il s'agit du premier segment, n'entrez que celui-ci
