...
**Smoothed Data**: The folder [Derived Ski routes](https://download.skitourenguru.com/public) holds a daily produced **smoothed version** of the data (collection and network). You can view the routes including foot sections with this [viewer](https://wiki.skitourenguru.com/map/flexmap.html?X=3&Y=44&Z=8&MAP=URI|1|IGN%20France|base|1.0|||https://data.geopf.fr/private/wmts?apikey=ign_scan_ws%26layer=GEOGRAPHICALGRIDSYSTEMS.MAPS%26style=normal%26tilematrixset=PM%26Service=WMTS%26Request=GetTile%26Version=1.0.0%26Format=image%2Fjpeg%26TileMatrix={z}%26TileCol={x}%26TileRow={y}-----URI|0|Mix%20Alps|base|0.8|||https://map.skitourenguru.com/AP_SG_TOPO_MINI.tms?x={x}%26y={y}%26z={z}-----URI|0|ESRI|base|1.0|||https://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}-----URI|0|ATHM%20(Skitourenguru)|overlay|0.4|||https://map.skitourenguru.com/AP_SG_ATHM.tms?x={x}%26y={y}%26z={z}-----URI|0|Slope%20angle%20classes|overlay|0.4|||https://map.skitourenguru.com/AP_SG_SACM5.tms?x={x}%26y={y}%26z={z}-----WMS|1|Sktours%20Alps|overlay|1.0|3857|France_Alps_SegmentsWithFootSections|https://gis.skitourenguru.com/cgi-bin/mapserv?map=VECTOR_MAP-----WMS|1|Sktours%20Pyrenees|overlay|1.0|3857|France_Pyrenees_SegmentsWithFootSections|https://gis.skitourenguru.com/cgi-bin/mapserv?map=VECTOR_MAP).
...
```
Now you can re-project from one projection to the other with the following commands:
```
